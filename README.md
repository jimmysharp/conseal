...
**Note:** While `struct-packages` is optional (omitting it will target all packages), it is **strongly recommended** to explicitly specify the packages containing your domain structs. This improves performance and prevents false positives in third-party or standard library code.
